...
@pytest.fixture(params=[
    ...
    ("","Некорректные данные"),  # Пустые данные
    ("Неизвестный тип 12345","Некорректные данные"),  # Неподдерживаемый формат
])
...
@pytest.fixture(params=[
    ...
    ("","Некорректная дата"),  # Пустая дата
    ("invalid-date-format","Некорректная дата"),  # Неверный формат
])
